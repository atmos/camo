...
(function() {
  var Crypto, Fs, Http, Https, Path, QueryString, Url, accepted_image_mime_types, camo_hostname, content_length_limit, current_connections, debug_log, error_log, finish, four_oh_four, hexdec, logging_enabled, max_redirects, port, process_url, script_directory, server, shared_key, socket_timeout, started_at, total_connections, version,
  ...
  accepted_image_mime_types = JSON.parse(Fs.readFileSync(Path.resolve(script_directory, "mime-types.json"), {
    encoding: 'utf8'
  }));
