...
(function() {
  var Crypto, Fs, Http, Https, Path, QueryString, Url, accepted_image_mime_types, camo_hostname, content_length_exceeded, content_length_limit, content_length_limit_redirect, current_connections, debug_log, default_security_headers, error_log, finish, four_oh_four, hexdec, keep_alive, logging_enabled, max_redirects, port, process_url, server, shared_key, socket, socket_timeout, started_at, three_oh_three, total_connections, version,
  ...
  console.log("SSL-Proxy running on " + ((socket != null) || port) + " with node:" + process.version + " pid:" + process.pid + " version:" + version + ".");

  server.listen((socket != null) || port);
