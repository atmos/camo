...
(function() {
  var Crypto, Fs, Http, Path, QueryString, Request, Url, accepted_image_mime_types, camo_hostname, content_length_limit, current_connections, debug_log, default_security_headers, error_log, finish, four_oh_four, hexdec, keep_alive, logging_enabled, max_redirects, port, process_url, proxy_url, server, shared_key, socket_timeout, started_at, total_connections, version,
  ...
  process_url = function(url, transferredHeaders, resp, remaining_redirects) {
    var queryPath, requestOptions, srcReq;
    if (url.host != null) {
