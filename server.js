...
(function() {
  var Crypto, Fs, Http, Https, Path, QueryString, Throng, Url, accepted_image_mime_types, camo_hostname, content_length_limit, current_connections, debug_log, default_security_headers, error_log, finish, four_oh_four, hexdec, keep_alive, listen, logging_enabled, max_redirects, port, process_url, server, shared_key, socket_timeout, started_at, total_connections, version, worker_count,
  ...
  server = Http.createServer(function(req, resp) {
    var base, dest_url, encoded_url, error, error1, hmac, hmac_digest, query_digest, ref, ref1, ref2, transferredHeaders, url, url_type, user_agent;
